    ...
    <div className="flex flex-col md:flex-row justify-center items-center min-h-screen bg-cover bg-center md:mt-6 "  >
      ...
      <div className="bg-white w-[95%] md:w-[60%] flex flex-col md:flex-row items-center  relative min-h-[500px] md:min-h-[600px] -top-1 " style={{ boxShadow: '0 -4px 10px rgba(0, 0, 0, 0.2)' }}>
        ...
        <div className="bg-white md:pr-10">
          ...
          <p className="text-[#6ca300] text-center md:text-start text-base md:text-xl mb-4">Feel free to drop us a line below!</p>
          <form className="space-y-4">
            <input
              type="text"
              placeholder="Your name"
              className="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#6ca300]"
            />
            <input
              type="email"
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#6ca300] h-32"
            ></textarea>
            <button
              type="submit"
              className="px-4 py-3 bg-[#6ca300] text-white rounded-full hover:bg-[#347746] transition duration-300 shadow-lg w-full"
            >
              SEND
            </button>
          </form>
