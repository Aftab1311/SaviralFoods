            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-center mb-8">
                    <div className="md:w-1/2 mb-6 md:mb-0">
                        <h5 className="text-sm tracking-wider text-gray-500 uppercase mb-2">Saviral Foods DEAL OF THE DAY</h5>
                        <h5 className="text-sm tracking-wider text-gray-500 uppercase mb-2">Saviral Foods DAIRY DEAL OF THE DAY</h5>
